#!/bin/bash
pathDatasetTUM_VI='/home/frejo/Master-thesis/datasets/TUM-mono' #Example, it is necesary to change it by the dataset path

#------------------------------------
# Monocular Examples
echo "Launching Room 1 with Monocular sensor"
#./Examples/Monocular/mono_tum Vocabulary/ORBvoc.txt Examples/Monocular/TUM1.yaml "$pathDatasetTUM_VI"/sequence_05
